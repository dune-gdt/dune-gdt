...
/// \file
/// \brief Provides the Eigen-backed dense container types EigenDenseVector, EigenMappedDenseVector and
/// EigenDenseMatrix.
...
public:
  ...
  void add_to_entry(const size_t ii, const size_t jj, const ScalarType& value)
  {
    assert(ii < rows());
    assert(jj < cols());
    [[maybe_unused]] const internal::LockGuard lock(*mutexes_, jj, cols());
    backend()(ii, jj) += value;
  } // ... add_to_entry(...)
