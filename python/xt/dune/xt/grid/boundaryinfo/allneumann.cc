...
public:
  using type = Dune::XT::Grid::AllNeumannBoundaryInfo<I>;
  ...
  static void bind_leaf_factory(pybind11::module& m, const std::string& class_id = "all_neumann_boundary_info")
  {
    using namespace pybind11::literals;
    m.def(
...
template <>
struct AllNeumannBoundaryInfo_for_all_grids<Dune::XT::Common::tuple_null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};


PYBIND11_MODULE(_grid_boundaryinfo_allneumann, m)
{
  namespace py = pybind11;
  ...
  AllNeumannBoundaryInfo_for_all_grids<>::bind(m);
}
