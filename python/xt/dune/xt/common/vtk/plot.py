...
if config.HAVE_K3D:
    ...
    def grid_plot(gridprovider, color_attribute_name, interactive=False, color_map=DEFAULT_COLOR_MAP):
        ...
        vtkplot = NumpyPlot(vertices,
                            ...
                            grid=combined_bounds,
                            interactive=interactive)
        vtkplot.grid_visible = True
        vtkplot.menu_visibility = not interactive
        vtkplot.camera = vtkplot.get_auto_camera(yaw=0, pitch=0, bounds=combined_bounds, factor=0.5)
        vtkplot.menu_visibility = True
        return vtkplot
