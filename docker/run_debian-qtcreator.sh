...
EXEC="/bin/bash"
DOCKER_HOME="${HOME}/.docker-homes/${CONTAINER}"


if [ -e ${CID_FILE} ]; then

  echo "An docker-qtcreator docker container for dune-gdt is already running."
  echo "Execute"
  echo "  ./${PROJECTDIR}/exec_debian-qtcreator.sh"
  ...
  echo "===================================================================================="
  echo "Starting a docker container for the oasys-solver-suite project"
