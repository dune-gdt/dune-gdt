...
[examples](examples), the tracked [benchmarks](benchmarks), and the generated
C++ API reference. New to dune-gdt? Start with the tutorials, then dip into the
examples for focused, self-contained snippets.
