...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        # out to this binary (via pymor's discretize_gmsh) to turn a plain polygonal 2D
        # domain into a mesh, which needs exactly these two. GRAPHICS/POST/PLUGINS above
        # stay OFF: nothing here touches a GUI or post-processing views.
        -DENABLE_MESH=ON
        -DENABLE_PARSER=ON
        -DENABLE_PROFILE=OFF
        ...
        # header-only and already a dune-gdt dependency (see vcpkg.json), so it costs
        # nothing extra to pull in here rather than wiring up BLAS/LAPACK linkage.
        -DENABLE_EIGEN=ON
        -DENABLE_GMP=OFF
        -DENABLE_OPENMP=OFF
        -DENABLE_POPPLER=OFF
