...
def test_build_sdist(monkeypatch, tmpdir):
    ...
    with tarfile.open(str(sdist)) as tar:
        ...
        with contextlib.closing(
                tar.extractfile(tar.getmember(start + "pybind11/share/cmake/pybind11/pybind11Config.cmake"))) as f:
...
def tests_build_wheel(monkeypatch, tmpdir):
    ...
    trimmed |= {"dist-info/{}".format(n.split("/", 1)[-1]) for n in names if "dist-info" in n}
